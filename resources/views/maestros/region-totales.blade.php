...
@section('content_header')
    <div class="mytitle">
        TOTAL DE MAESTROS DE LA {{$region->region}} - {{$region->sede}} 
    </div>    
@stop
    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="row justify-content-between" style="padding-right:7px">
                ...
                <div>
                    <h4>
                        <strong> {{ $maestrosCount }} </strong> MEASTROS EN TOTAL

                    </h4>
                </div>            
                <a href="{{ route('region.index') }}" class="btn btn-secondary float-right ml-2">
                ...
                <x-adminlte-datatable id="table1" :heads="$heads" :config="$config" striped hoverable with-footer with-buttons  bordered >
                    ...
                    @foreach($maestros as $maestro)
                        <tr>
                            ...
                            <td>{{ $maestro->delegacion->delegacion }}</td>
